...
require_once '../controlador/CBitacora.php';
$bit=new CBitacora();
$result =  $bit->mostrarBitacora();
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Docentes » Administrar Docentes</h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                        ...
                                        <tbody>
                                            <?php while ($row = mysql_fetch_array($result)) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $row['usuarioPc']; ?></td>
                                                    <td><?php echo $row['usuarioBd']; ?></td>
                                                    <td><?php echo $row['claseBd']; ?></td>
                                                    <td><?php echo $row['accionInClass']; ?></td>                        
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
