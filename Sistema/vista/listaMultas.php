    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Multa » Listar Multas</h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                            ...
                            <div class="panel-heading">
                              ...
                              <?php if (isset($_GET['multa'])) { ?>
                                <div class="alert alert-warning">
                                    El estudiante<strong class="mayuscula"><?php echo $_GET['multa'];?></strong>Tiene Multa <br>
                                    No Puede realizar mas Prestamos si no Procede a cancelar.
                                        ...
                                        <tbody>
                                            <?php while ($row = mysql_fetch_array($result)) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $row['descripcionMulta']; ?></td>
                                                    <td><?php echo $row['precioMulta']; ?></td>
                                                    <td><?php echo $row['estado']; ?></td>
                                                    <td>
                                                        <?php
                                                        if ($row['estado'] == 'A') {
                                                            echo '<input type="submit" class="btn btn-outline btn-primary" value="CANCELAR">';
                                                        }
                                                        if ($row['estado'] == 'I') {
                                                            echo  '';
                                                        }
