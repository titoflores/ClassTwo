                                    ...
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                ...
                                                <div>devolucion en fecha <br> <?php
                                                    echo date("Y-m-d");
                                                    ?></div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <p>Bienvenido al <strong>Panel de Administración</strong> de la <strong>Biblioteca de la Universidad</strong>.</p>
                                        <p>Al lado <strong>izquierdo</strong> de su pantalla, encontrará las opciones permitidas.
                                        <ol>
                                            <li><strong>Principal</strong></li>
                                            <li><strong>Biblioteca</strong></li>
                                            <ul>
                                                <li>Material Fisico</li>
                                                <li>Material Digital</li>
                                            </ul><br>
                                            <li><strong>Prestamo</strong></li>
                                            <ul>
                                                <li>Registrar Prestamo</li>
                                                <li>Listar Prestamos</li>
                                            </ul><br>
                                            <li><strong>Devolucion</strong></li>
                                            <ul>
                                                <li>Registrar Devolucion</li>
                                                <li>Listar Devolucion</li>
                                            </ul>
                                        </ol>
                                        </p>
                                    </div>
