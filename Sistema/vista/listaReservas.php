                                        ...
                                        <tbody>
                                            <?php while ($row = mysql_fetch_array($result)) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="prestamo_add.php?registro=<?php echo $row['registro']; ?>&palabra=<?php echo $row['codLibro']; ?>&checked=checked" class="fa fa-book" >&nbsp;Prestar</a> </td>                          
                                                </tr>
<?php } ?>
                                        </tbody>
                                    </table>
