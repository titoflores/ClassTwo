...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default (Se filtraron _MAX_ del total de entradas)
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Se filtraron _MAX_ del total de entradas)",
			 ...
			 *  @type string
			 *  @default No hay registros que coincidan con la busqueda
			 *
			 *  @dtopt Language
